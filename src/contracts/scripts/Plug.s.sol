...
contract PlugDeployment is Script {
    function run() external {
        ...
        PlugEtcherLib.FACTORY.safeCreate2(
            PlugEtcherLib.PLUG_NOUNS_TRAIT_SALT,
            PlugEtcherLib.PLUG_NOUNS_TRAIT_INITCODE
        );

        PlugEtcherLib.FACTORY.safeCreate2(
            PlugEtcherLib.PLUG_REVOCATION_SALT,
            PlugEtcherLib.PLUG_REVOCATION_INITCODE
        );

        PlugEtcherLib.FACTORY.safeCreate2(
            PlugEtcherLib.PLUG_TIMESTAMP_SALT,
            PlugEtcherLib.PLUG_TIMESTAMP_INITCODE
        );
