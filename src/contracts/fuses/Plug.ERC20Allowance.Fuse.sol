...
contract PlugERC20AllowanceFuse is PlugFuse {
    ...
    bytes4 public constant ERC20_TRANSFER_FROM = bytes4(keccak256("transfer(address,uint256)"));
        ...
        returns (bytes memory $through)
    {
        ...
        require(targetSig == ERC20_TRANSFER_FROM, "ERC20AllowanceEnforcer:invalid-method");
     ...
     */
    function decode(bytes calldata $terms) public pure returns (uint256 $limit) {
